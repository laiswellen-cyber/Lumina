          ...
          >
            {({ values, handleChange, handleSubmit: submit, resetForm }) => (
              <Area style={{ width: "100%", gap: 14 }}>
                ...
                {result ? (
                  <Area style={{ width: "100%", padding: 18, backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 16 }}>
                    <Text style={{ color: "#f8fafc", fontSize: 18, fontWeight: "700", textAlign: "center" }}>
                      {result}
                    </Text>
                    {imc !== null ? (
                      <Text style={{ color: "#d1fae5", fontSize: 14, marginTop: 10, textAlign: "center" }}>
                        IMC entre 18,5 e 24,9 é considerado peso correto.
                      </Text>
                    ) : null}
                    {category ? (
